  ...
  const socialLinks = [
    {
      ...
      link: "https://www.facebook.com/JoheatEnterprises",
    },
    { icon: XLogoIcon, link: "https://x.com/JohatEnter3002" },
    {
      icon: InstagramLogoIcon,
      link: "https://www.instagram.com/accounts/login/?next=%2Fjohatenterprises%2F&source=omni_redirect",
    },
    {
      icon: LinkedinLogoIcon,
      link: "https://www.linkedin.com/in/james-taylor-69b20544/",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6 max-w-[420px] mt-3">
            <a
              ...
              className="text-decoration-none text-xl md:text-2xl lg:text-[28px] font-bold"
            >
              +1-231-427-2289
            </a>
            <a
            ...
            <a
              href="mailto:johat1o11953@outlook.com"
              className="text-decoration-none text-xl md:text-2xl lg:text-[28px] font-bold break-words"
            >
            ...
            <a
              ...
              className="text-decoration-none text-base md:text-lg text-gray-600 leading-relaxed"
            >
              3975 Pulverwoods Rd,
              <br />
          ...
          <div>
            ...
            >
              ...
              {/* Message */}
              <div>
                <label className="text-xs md:text-sm font-bold">MESSAGE</label>
                <textarea
                  rows="4"
                  {...register("message")}
                  className="w-full mt-1 p-3 bg-white outline-none"
